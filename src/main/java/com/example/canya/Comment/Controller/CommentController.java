...
public class CommentController {
    ...
    public ResponseEntity<?> createComment (@PathVariable Long boardId, @RequestBody com.example.canya.comment.dto.CommentRequestDto commentRequestDto, @AuthenticationPrincipal com.example.canya.member.service.MemberDetailsImpl memberDetails) {
    ...
    public ResponseEntity<?> commentUpdate(@PathVariable Long commentId, @RequestBody com.example.canya.comment.dto.CommentRequestDto commentRequestDto, @AuthenticationPrincipal com.example.canya.member.service.MemberDetailsImpl memberDetails) {
